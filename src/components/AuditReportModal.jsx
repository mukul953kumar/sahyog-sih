      ...
      <div className="w-full max-w-lg bg-white rounded-2xl shadow-2xl overflow-hidden border border-slate-300 flex flex-col max-h-[90vh]">
        ...
        <div className="bg-primary text-white p-4 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h3 className="text-base font-black">Public Cooperative Audit Ledger</h3>
        ...
        <div className="p-4 overflow-y-auto flex flex-col gap-3 text-xs text-slate-800">
          <div className="grid grid-cols-2 gap-2 bg-slate-50 p-3 rounded-xl border border-slate-200">
            <div>
              <span className="text-slate-500 font-semibold block">Gross Transaction Volume:</span>
            ...
            <div>
              <span className="text-slate-500 font-semibold block">Total Commissions Saved:</span>
          ...
          <div>
            <span className="font-bold text-slate-700 block mb-1 uppercase tracking-wider text-[10px]">
              Recent Escrow Payouts (Real-Time Block Ledger)
            </span>
            <div className="border border-slate-200 rounded-lg overflow-hidden divide-y divide-slate-200 font-mono text-[11px]">
              <div className="bg-slate-100 p-2 font-bold flex justify-between">
                <span>TX Hash / ID</span>
                <span>Worker Share</span>
                <span>Commission</span>
                <span>Status</span>
              </div>
              <div className="p-2 flex justify-between items-center bg-white">
                <span className="font-sans font-semibold">#SHG-8821 • Ramesh K.</span>
                <strong className="text-emerald-700">₹450 (100%)</strong>
                <span className="text-slate-500">₹0</span>
                <span className="bg-emerald-100 text-emerald-800 font-sans text-[10px] px-1.5 py-0.5 rounded font-bold">Escrow Released</span>
              </div>
              <div className="p-2 flex justify-between items-center bg-white">
                <span className="font-sans font-semibold">#SHG-8790 • Sunita P.</span>
              ...
              <div className="p-2 flex justify-between items-center bg-white">
                <span className="font-sans font-semibold">#SHG-8642 • Mohammad A.</span>
          ...
          <div className="p-2.5 bg-emerald-50 rounded-lg border border-emerald-200 text-emerald-900 text-[11px]">
            <strong>Audit Verification Statement:</strong> No aggregator platform margin was collected on any transaction. All surplus is held in the registered cooperative mutual fund.
          </div>
        </div>
        ...
        <div className="bg-slate-100 p-3 flex items-center justify-between border-t border-slate-200">
          <button
            onClick={() => alert('Cooperative Audit Ledger exported as SAHYOG_Audit_Q3_2026.csv')}
